...
class MyFlaskApp(Flask):
    def run(self, host=None, port=None, debug=None, **options):
        ...
        self.body_index_path = '322514282/postings_gcp_text'
        self.title_index_path = '322514282/postings_gcp_title'
        self.anchor_index_path = '322514282/postings_gcp_anchor'
        self.dl_path = '322514282/dl/dl.pkl'
        self.dt_path = '322514282/dt/dt.pkl'
        ...
        with fs.open('gs://322514282/dl/dl.pkl', 'rb') as f: 
            self.DL = pickle.load(f)
            self.DL_LEN = len(self.DL)

        with fs.open('gs://322514282/dt/dt.pkl', 'rb') as f: 
...
def search():
    ...
    for i in range(len(app.body_res)):
        id_ranking[app.body_res[i][0]] += 30 / (i + 1)
    anchor_thread.join()
